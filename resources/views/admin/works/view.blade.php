                  ...
                  <div class="card-body card-dashboard">
                    ...
                    @foreach($works as $work)
                        <tr class="gradeX">
                            ...
                            <td><img src="{{asset('/storage/work_images/'.$work->image)}}" width="100" height="100"></td>
                            ...
                            <td>
                                ...
                                |
                                <a href="{{route('admin.work.destroy',$work->id)}}">
...
<script>
  $(document).ready(function ()
  {
    toastr.error('<?php echo Session::get('error');?>', '削除', {timeOut: 2000})
  });
</script>
@endif
@endsection
