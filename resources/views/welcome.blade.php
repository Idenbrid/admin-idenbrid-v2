...
.loader{
 ...
 .loader .loader-inner:before{
    ...
    height: 14%;
    border-radius: 100%;
    background: linear-gradient(to left, #ED1C24, #ED1C24);
    margin: 0 auto;
...
<body class="antialiased">
    ...
    <script src="/js/swiper_slider/swiper-bundle.min.js"></script>
    <script src="/js/bootstrap-toggle.min.js"></script>
    <script src="/js/popper.min.js"></script>
    <script src="/js/fontawesomekit.js" crossorigin="anonymous"></script>
    <script src="{{ mix('/js/app.js') }}"></script>
    <script src="/js/jquery.preloadinator.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.4.4/vue.min.js"></script>
    <script src="https://unpkg.com/vue-chartjs@3.0.0/dist/vue-chartjs.full.min.js"></script>
