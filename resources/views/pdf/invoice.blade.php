...
<main>
 <div id="details" class="clearfix">
     <div id="client">
         ...
         <h2 class="name">Dear: {{$order_detail['company_name']}}</h2>
          <div class="phone_no">Phone no: +92{{$phone}}</div>
         <div class="address">Address: {{$address}}</div>
         <div class="email">Email: <a href="mailto:kashif.idenbrid@gmail.com">{{$email}}</a></div>
         {{-- <div class="position">Postition: Wordpress Developer</div>
         <div class="cnic">CNIC: 3540427931623</div> --}}
     </div>
     <div id="invoice">
         <h1>INVOICE #{{$order_detail['id']}}</h1>
         <div class="date">Date of Invoice: {{$order_detail['created_at']}}</div>
 ...
 <table border="0" cellspacing="0" cellpadding="0">
     ...
     <tbody>
         <tr>
             <td class="no">{{$order_detail['id']}}</td>
             <td colspan="2" class="desc">
                 <h3>{{$order_detail['package_name']}}</h3>
             </td>
             <td class="unit">{{$order_detail['price']}}</td>
             <td class="total">{{$order_detail['price']}}</td>
         </tr>
     </tbody>
     <tfoot>
         <tr>
